...
import com.thebst.thebstsearchengine.screens.WelcomePanel;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        setPage(new WelcomePanel(this));
        
        this.screenPanel.setSize(new Dimension(1200, 600));
    ...
    public final void setPage(JPanel page) {
        ...
        screenPanel.add("currentPage", page);
        ((CardLayout)(screenPanel.getLayout())).show(screenPanel, "currentPage");
